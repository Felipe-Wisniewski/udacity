...
class HuntMainActivity : AppCompatActivity() {
    ...
    /** When the user clicks on the notification, this method will be called, letting us know that
        the geofence has been triggered, and it's time to move to the next one in the treasurehunt.*/
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>,
        ...
        if (grantResults.isEmpty() ||
            ...
            // Permission denied.
            Snackbar.make(binding.activityMapsMain, R.string.permission_denied_explanation,
    ...
    /** This will also destroy any saved state in the associated ViewModel, so we remove the geofences here.*/
