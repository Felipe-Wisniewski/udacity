...
class GdgListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        viewModel.showNeedLocation.observe(viewLifecycleOwner, Observer<Boolean> { show -> // Snackbar is like Toast but it lets us show forever
                if (show == true) {
                    Snackbar.make(
                        binding.root,
        ...
        viewModel.regionList.observe(this, Observer { data ->
            data?.let {
